      ...
      body: ListView(
        ...
        children: [
          ...
          Padding(
            ...
            child: Center(
              child: ElevatedButton(
                child: const Text('Go to DownloadButton Demo Page =>'),
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const DownloadButtonDemo()),
                  );
                },
              ),
            ),
...
class DownloadButtonDemo extends StatelessWidget {
  const DownloadButtonDemo({Key? key}) : super(key: key);
